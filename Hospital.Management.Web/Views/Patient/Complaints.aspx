    ...
    <script type="text/javascript">
        ...
        function Ctrl($scope, $http) {
            ...
            $scope.edit = function (div, row) {
                ...
                $("#" + div + " > table > tbody > tr:nth-child(" + row + ") > td > span.label.label-info.save").show();
            ...
            $scope.saveNew = function () {
                ...
                $http.post("/Patient/SaveComplaint/" + $scope.id, { json: $scope.patient.complaints[$scope.patient.complaints.length - 1] }).success(function () {
            ...
            $scope.claim = function (id) {
                ...
                $http.post("/Patient/TakeExamination/" + $scope.id, { examinationId: id }).success(function () {
...
<asp:Content ID="Content6" ContentPlaceHolderID="BreadcrumbCPH" runat="server">
    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li>
                <i class="icon-user crumb"></i>
                <a href="/Patient/Complaints/{{id}}">Complaints</a>
            </li>
        </ul>
        ...
        <div class="widget box">
            <div class="widget-header">
                ...
                <div class="toolbar no-padding">
                    <div class="btn-group">
                        <span class="label label-info" style="float: left; margin-top: 10px; margin-right: 10px;" ng-click="new()">New</span>                        
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="complaint in patient.complaints">
                                                ...
                                                <td>
                                                    <span class="label label-warning" ng-click="edit('tab_1_2',complaint.index)" ng-if="complaint.status == 0">Edit</span>
                                                    <span class="label label-info save" ng-click="save()" style="display: none;">Save</span>
                                                    <span class="label label-info" ng-click="saveNew()" style="display: none;">Save</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr ng-repeat="examination in examinationss">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="label label-success" ng-if="examination.examination.status == 1">Claimed</span>
                                                </td>
                                                <td>
                                                    <span class="label label-warning" ng-if="examination.examination.status == 0" ng-click="claim(examination.examination.id2)">Claim</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
