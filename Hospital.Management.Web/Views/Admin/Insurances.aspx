...
<asp:Content ID="Content3" ContentPlaceHolderID="NgCPH" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Ctrl($scope, $http) {
            ...
            var urlLoad = "/Admin/AllInsurances";
            var urlSave = "/Admin/SaveInsurance";
            var urlDelete = "/Admin/DeleteInsurance";

            $scope.data = [];

            $scope.generate = function () {

                return { index: $scope.data.length + 1, name: "", discount: null };
...
<asp:Content ID="Content6" ContentPlaceHolderID="BreadcrumbCPH" runat="server">
    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li>
                <i class="fa fa-line-chart crumb"></i>
                <a href="/Admin/Insurances">Insurance Methods</a>
            </li>
        </ul>
    ...
    <div class="col-md-12">
        <div class="widget box">
            <div class="widget-header">
                <h4><i class="icon-reorder"></i>Insurance Methods</h4>
            ...
            <div class="widget-content">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr ng-repeat="insurance in data">
                            <td>{{insurance.index}}</td>
                            <td>
                                <label>{{insurance.name}}</label>
                                <input class="form-control input-width-medium" type="text" style="display: none; margin-top: 6px;" ng-model="insurance.name" placeholder="Name" />
                            </td>
                            <td>
                                <label>{{insurance.discount}} %</label>
                                <input class="form-control input-width-medium" type="text" style="display: none; margin-top: 6px;" ng-model="insurance.discount" placeholder="Discount" />
                            </td>                           
                            <td>
                                <span class="label label-info" ng-click="save(insurance.index)" style="display: none">Save</span>
                                <span class="label label-warning" ng-click="edit(insurance.index)">Edit</span>
                                <span class="label label-danger" ng-click="delete(insurance.index)">Delete</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
