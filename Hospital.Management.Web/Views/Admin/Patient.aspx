    ...
    <script type="text/javascript">
        ...
        function Ctrl($scope, $http) {
            ...
            $scope.refresh = function () {
                ...
                $http.get("/Admin/PatientById/" + id).success(function (data) {
            ...
            $scope.save = function () {
                ...
                $http.post("/Admin/SavePatient", { json: $scope.patient }).success(function () {
...
<asp:Content ID="Content6" ContentPlaceHolderID="BreadcrumbCPH" runat="server">
    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li>
                <i class="icon-user crumb"></i>
                <a href="/Admin/Patient/{{id}}">{{patient.name + ' ' + patient.surname}}</a>
            </li>
        </ul>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tabbable tabbable-custom">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#tab_1_2" data-toggle="tab">Complaints</a></li>
                                        ...
                                        <div class="col-md-6">
                                            <form class="form-horizontal row-border" action="#">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="regular" class="form-control" ng-model="patient.name">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Surname:</label>
                                                    <div class="col-md-9">
                                                        <input type="text" name="regular" class="form-control" ng-model="patient.surname">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Age:</label>
                                                    <div class="col-md-9">
                                                        <input type="text" name="regular" class="form-control" ng-model="patient.age">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Email:</label>
                                                    <div class="col-md-9">
                                                        <input type="text" name="regular" class="form-control" ng-model="patient.email">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Phone:</label>
                                                    <div class="col-md-9">
                                                        <input type="text" name="regular" class="form-control" ng-model="patient.phone">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Insurance:</label>
                                                    <div class="col-md-9">
                                                        <select class="form-control" ng-model="patient.insurance" ng-options="i.name for i in insurances track by i.id">
                                                        </select>
                                                    </div>
                                                </div>
                                            </form>
