...
<asp:Content ID="Content3" ContentPlaceHolderID="NgCPH" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Ctrl($scope, $http) {
            ...
            var urlLoad = "/Doctor/ById/" + glossary.get("id");
            var urlSave = "/Doctor/SaveInfo/" + glossary.get("id");            
    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li>
                ...
                <a href="/Doctor/Index/{{id}}">{{info.name + ' ' + info.surname}}</a>
            </li>
            <li>
                <i class="icon-pencil crumb"></i>
                <a href="/Doctor/Info/{{id}}">Info</a>
            </li>
        </ul>
